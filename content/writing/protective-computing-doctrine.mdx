...
<figure>
	<img
		...
		alt="Threat boundary map for protective systems under instability and coercion risk"
	/>
	<figcaption>
...
- Defaults to local authority.
- Lets the user read and act without a server round trip.
- Preserves progress when the session is interrupted.
